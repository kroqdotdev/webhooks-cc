...
| `teams`        | name, owner_id, polar_customer_id, polar_subscription_id, subscription_status, seats, requests_used, request_limit, period_end | Membership/sharing live in `team_members`, `team_invites`, `team_endpoints`; active iff `subscription_status is not null` |
