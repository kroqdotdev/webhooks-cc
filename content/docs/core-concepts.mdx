---
title: "Core Concepts"
description: "Learn the core concepts of webhooks.cc — endpoints, slugs, request capture, mock responses, CLI tunneling, and quotas — and how they fit your webhook testing workflow."
...
seo:
  ogTitle: "Core Concepts"
  ogDescription: "Learn the core concepts of webhooks.cc — endpoints, slugs, request capture, mock responses, CLI tunneling, and quotas — and how they fit your webhook testing workflow."
---
...
Configure from the dashboard settings dialog, the SDK, or the MCP server. See the [notification webhooks guide](/docs/notification-webhooks) for setup details.
...
Provider templates are pre-built webhook payloads for common services. Each template includes realistic data and, when the provider supports shared-secret or token-style signing, matching signature headers so your handler can verify them.

Supported providers (32): **Stripe**, **GitHub**, **Shopify**, **Twilio**, **Slack**, **Paddle**, **Linear**, **SendGrid**, **Clerk**, **Discord**, **Vercel**, **GitLab**, **Typeform**, **Standard Webhooks** (Polar, Svix, Resend), **Meta**, **Lemon Squeezy**, **Coinbase Commerce**, **Razorpay**, **Cal.com**, **Intercom**, **Telegram**, **Square**, **HubSpot**, **Mailgun**, **Calendly**, **Mux**, **Sentry**, **Bitbucket**, **DocuSign**, **Adyen**, **PayPal**, and **Plaid**.
...
Verification requires the provider's signing secret or verification credential, which you configure in your application. The SDK supports signature verification for 30 providers: Stripe, GitHub, Shopify, Twilio, Slack, Paddle, Linear, Clerk, Discord (Ed25519), Vercel, GitLab, Typeform, Standard Webhooks, Meta, Lemon Squeezy, Coinbase Commerce, Razorpay, Cal.com, Intercom, Telegram, Square, HubSpot, Mailgun, Calendly, Mux, Sentry, Bitbucket, DocuSign, Adyen, and PayPal. SendGrid and Plaid are template-only for verification.
...
<Callout type="tip">
  ...
  request, not when you sign up. See [Plans & Limits](/docs/plans-limits) for full details on
  quotas, retention, and rate limits.
</Callout>
