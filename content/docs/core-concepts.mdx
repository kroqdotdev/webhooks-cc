...
Supported providers (28): **Stripe**, **GitHub**, **Shopify**, **Twilio**, **Slack**, **Paddle**, **Linear**, **SendGrid**, **Clerk**, **Discord**, **Vercel**, **GitLab**, **Typeform**, **Standard Webhooks** (Polar, Svix, Resend), **Meta**, **Lemon Squeezy**, **Coinbase Commerce**, **Razorpay**, **Cal.com**, **Intercom**, **Telegram**, **Square**, **HubSpot**, **Mailgun**, **Calendly**, **Mux**, **Sentry**, and **Bitbucket**.
