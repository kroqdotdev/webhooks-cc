...
Each accepted invite claims a seat. When members equal seats, the team is full — add a seat before inviting anyone else. Removing a member (or a member leaving) frees their seat for reuse.
