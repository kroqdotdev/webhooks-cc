...
**Shared endpoints behave like your own.** Any endpoint shared with you through a subscribed team can be listed, inspected, streamed, searched, and forwarded by slug. Each endpoint carries `fromTeam` (shared with you) or `sharedWith` (yours, shared with a team) so you can tell them apart.
