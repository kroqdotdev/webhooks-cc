...
3. Any email address works: they get an invite email, and if they don't have an account yet, the invite is waiting for them after they sign up with that address
