...
description: "Complete reference for all 24 MCP tools available to AI coding agents. Parameters, return types, and usage examples for endpoint, request, and webhook operations."
section: mcp
order: 2
...
seo:
  ...
  ogDescription: "Complete reference for all 24 MCP tools available to AI coding agents. Parameters, return types, and usage examples for endpoint, request, and webhook operations."
---
