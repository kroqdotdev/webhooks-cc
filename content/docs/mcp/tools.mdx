...
| `provider` | `string` | no                      | Provider template (`stripe`, `github`, `shopify`, `twilio`, `slack`, `paddle`, `linear`, `sendgrid`, `clerk`, `discord`, `vercel`, `gitlab`, `typeform`, `standard-webhooks`, `meta`, `lemonsqueezy`, `coinbase-commerce`, `razorpay`, `cal`, `intercom`, `telegram`, `square`, `hubspot`, `mailgun`, `calendly`, `mux`, `sentry`, `bitbucket`) |
...
| ----------- | -------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `requestId` | `string` | yes      | Request ID                                                                                                                                                                                                                                                                                                                                                    |
| `provider`  | `string` | no       | Provider name (`stripe`, `github`, `shopify`, `twilio`, `slack`, `paddle`, `linear`, `discord`, `clerk`, `vercel`, `gitlab`, `typeform`, `standard-webhooks`, `meta`, `lemonsqueezy`, `coinbase-commerce`, `razorpay`, `cal`, `intercom`, `telegram`, `square`, `hubspot`, `mailgun`, `calendly`, `mux`, `sentry`, `bitbucket`). Omit to return stored result |
