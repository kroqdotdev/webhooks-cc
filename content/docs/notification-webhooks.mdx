...
description: "Get notified the moment a webhook arrives. POST a JSON summary to Slack, Discord, Microsoft Teams, or any custom webhook-compatible service — no polling required."
section: dashboard
order: 7
...
seo:
  ogTitle: "Webhook Notifications Guide"
  ogDescription: "Get notified the moment a webhook arrives. POST a JSON summary to Slack, Discord, Microsoft Teams, or any custom webhook-compatible service — no polling required."
---
