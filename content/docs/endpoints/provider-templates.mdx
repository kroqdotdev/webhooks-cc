...
description: "Detailed reference for all 13 webhook provider templates. Payload shapes, signature methods, headers, and event types for Stripe, GitHub, Shopify, Twilio, Slack, Paddle, Linear, SendGrid, Clerk, Discord, Vercel, GitLab, and Standard Webhooks."
section: dashboard
order: 3
...
seo:
  ...
  ogDescription: "Payload shapes, signature methods, headers, and event types for all 13 supported webhook provider templates. Covers Stripe, GitHub, Shopify, Twilio, Slack, and more."
---
