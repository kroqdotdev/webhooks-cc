...
description: "Verify webhook signatures for Stripe, GitHub, Shopify, and 11 more providers using HMAC-SHA256 and asymmetric algorithms. Protect handlers from forged payloads."
section: guides
order: 5
...
seo:
  ...
  ogDescription: "Verify webhook signatures for Stripe, GitHub, Shopify, and 11 more providers using HMAC-SHA256 and asymmetric algorithms. Protect handlers from forged payloads."
---
...
The webhooks.cc SDK verifies signatures for 14 providers with a single function call. This guide walks through the process for each one.
...
Replace `"stripe"` with any supported provider name: `"github"`, `"shopify"`, `"twilio"`, `"slack"`, `"paddle"`, `"linear"`, `"sendgrid"`, `"clerk"`, `"discord"`, `"vercel"`, `"gitlab"`, `"typeform"`, or `"standard-webhooks"`.
