...
description: "Run webhook integration tests in GitHub Actions, GitLab CI, and other CI environments. Use deterministic, signed payloads for repeatable assertions in your pipeline."
section: guides
order: 6
...
seo:
  ogTitle: "Webhook Testing in CI/CD"
  ogDescription: "Run webhook integration tests in GitHub Actions, GitLab CI, and other CI environments. Use deterministic, signed payloads for repeatable assertions in your pipeline."
---
...
<LinkCard
  ...
  description="Verify signatures for 30 signed providers with the SDK. Protect your handlers from forged payloads."
/>
