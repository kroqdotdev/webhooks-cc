...
description: "Combine Playwright browser automation with webhook assertions for end-to-end checkout or onboarding flows. Verify both the UI and the webhook."
section: sdk
order: 7
...
seo:
  ogTitle: "E2E Webhook Testing with Playwright"
