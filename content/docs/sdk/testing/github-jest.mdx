---
title: "GitHub + Jest"
description: "Validate GitHub push and pull request webhook events in a Jest integration suite with HMAC-SHA256 signature verification."
section: sdk
order: 6
...
seo:
  ogTitle: "GitHub Webhook Assertions with Jest"
