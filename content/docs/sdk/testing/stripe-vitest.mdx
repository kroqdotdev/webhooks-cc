---
title: "Stripe + Vitest"
description: "End-to-end Stripe webhook assertion pattern using endpoint lifecycle setup and teardown. Verify checkout.session.completed events in Vitest."
section: sdk
order: 5
...
seo:
  ogTitle: "Stripe Webhook Testing with Vitest"
