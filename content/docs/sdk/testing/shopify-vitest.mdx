...
description: "Test Shopify webhook handlers with HMAC-SHA256 signed payloads using the webhooks.cc SDK and Vitest. Full example with endpoint lifecycle and assertion patterns."
section: sdk
order: 9
...
seo:
  ogTitle: "Test Shopify Webhooks with Vitest"
  ogDescription: "Test Shopify webhook handlers with HMAC-SHA256 signed payloads using the webhooks.cc SDK and Vitest. Full example with endpoint lifecycle and assertion patterns."
---
...
<LinkCard
  ...
  description="Verify signatures for 20 signed providers."
/>
