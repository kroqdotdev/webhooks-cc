...
Detector functions identify common providers from headers and, for SendGrid, body shape. Use `detectWebhookInfo` when you want the provider and event/topic, or the boolean helpers when you only need to route one provider.
...
<LinkCard
  ...
  description="Verify webhook signatures for 27 signed providers."
/>
