...
A key has exactly the team access of the account it belongs to. Endpoints shared with you already show up in `endpoints.list()` and work with every request method by slug; this namespace manages the teams themselves.
