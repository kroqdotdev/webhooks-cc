...
seo:
  ...
  ogDescription: "Verify webhook signatures for 13 providers using the webhooks.cc TypeScript SDK. Supports HMAC-SHA256, HMAC-SHA1, Ed25519, and token comparison."
---
