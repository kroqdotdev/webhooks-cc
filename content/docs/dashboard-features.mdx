...
schema: none
keywords: ["dashboard", "keyboard shortcuts", "pin requests", "compare requests", "timeline", "webhook inspector"]
seo:
...
<Steps>
  ...
  <Step title="Add a note">Click **Add note...** below the request detail header. Type your note and press Enter.</Step>
  <Step title="Find annotated requests">Requests with notes show a sticky note icon in the list.</Step>
</Steps>
